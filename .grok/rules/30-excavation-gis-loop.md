...
5. Graph: QUICK solo; FEATURE/gis/debug/architecture summon the full matching expert set this turn.
6. Loop: build + tests this turn after `src/` edits. Evidence before 완료.
